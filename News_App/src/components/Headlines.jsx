    ...
    <>
      ...
      >
        <div className=" h-screen bg-base-100 overflow-y-auto  w-100 scrollbar-none">
          <h2 className="text-xl font-bold italic bg-black/90 px-2 py-4 sticky top-0 z-10">
            Top News :
          </h2>
          <ul
          ...
          >
            {topNews.map((news, i) => (
              <li className="rounded-xl bg-black/20 p-4 px-6" key={i}>
                <img
                ...
                <p className=" mt-6">
                  <a
                    className="text-center cursor-pointer text-blue-500 hover:brightness-75 "
                    target="_blank"
                    href={news?.url}
                  >
                    {news?.title}
